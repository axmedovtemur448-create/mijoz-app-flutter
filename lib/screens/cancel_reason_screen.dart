...
class CancelReasonScreen extends StatefulWidget {
  final int orderId;
  const CancelReasonScreen({super.key, required this.orderId});
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: (_selected == null || _sending) ? null : _confirmCancel,
                  child: Text(_sending ? "Yuborilmoqda..." : "Bekor qilish",
