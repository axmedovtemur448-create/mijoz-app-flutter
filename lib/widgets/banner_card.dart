...
class BannerCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final content = Container(
      ...
      height: 160,
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(18), color: bgColor),
      child: Column(
                ...
                children: [
                  ...
                  if (badge != null) ...[
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(color: const Color(0xFFFFC800), borderRadius: BorderRadius.circular(6)),
                      child: const Text("PREMIUM", style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Color(0xFF1B1B1B))),
                    ),
                  ],
                ],
              ),
    ...
    return Padding(
      padding: const EdgeInsets.only(bottom: 14),
      child: GestureDetector(onTap: onTapWhole, child: ClipRRect(borderRadius: BorderRadius.circular(18), child: content)),
    );
  }
}
