...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void openService(ServiceInfo s) {
      if (s.id == "taxi") {
        goToTaxiOrder();
        return;
      }
      Navigator.of(context).push(MaterialPageRoute(builder: (_) => ServiceDetailScreen(title: s.name, emoji: s.emoji)));
    }
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(onTap: goToServices, child: const Text("Barchasi ›", style: TextStyle(fontSize: 13, color: Color(0xFF8A8A8A)))),
              ],
            ),
            ...
            GridView.count(
              ...
              children: homeServices.map((s) => ServiceItemWidget(service: s, onTap: () => openService(s))).toList(),
            ),
                ...
                children: [
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const [
                        Text("Do'stlaringizni taklif qiling", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Color(0xFF1B1B1B))),
                        SizedBox(height: 4),
