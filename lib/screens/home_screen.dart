  ...
  Widget build(BuildContext context) {
    ...
    void openService(ServiceInfo s) {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(builder: (_) => ServiceDetailScreen(title: s.name, emoji: s.emoji)),
      );
    }
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Banner ekran chetlariga yaqinroq bo'lishi uchun kichikroq gorizontal bo'shliq
            Padding(
                ...
                children: [
                  ...
                  GridView.count(
                    ...
                    children: homeServices
                        .map((s) => ServiceItemWidget(service: s, onTap: () => openService(s)))
                        .toList(),
                  ),
